...
if No_OF_PLIES == 3:
    ...
    print("Board_GSM")
    print(Board_GSM)  
Weight=((decal*Sheet_size*Board_GSM)/1550)/1000000#To_covert_amount_of_weight_into_grams.
print("WEIGHT")
print(Weight)
...
Box_Rate=((Weight*Current_Paper_Rate)+Conversion_rate) 
print("Rate_OF_BOX\n")
print(f"Rs:.{Box_Rate}")
